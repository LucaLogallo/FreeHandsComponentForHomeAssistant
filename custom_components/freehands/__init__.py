...
# def on_connect(client, userdata, flags, rc):
#     if rc == 0:
#         _LOGGER.info("Connected to Gateway's MQTT Broker!")
#         client.subscribe("#")
#     else:
#         _LOGGER.info("freeHands failed to connect, return code %d\n", rc)
...
# def on_connectToFreehands(client, userdata, flags, rc):
#     if rc == 0:
#         _LOGGER.info("Connected to Freehands!")
#         client.subscribe("#")
#     else:
#         _LOGGER.info("freeHands failed to connect, return code %d\n", rc)
...
#         _LOGGER.info("Message received from freehands")
...
#     transport="tcp",
# )
# client1.username_pw_set(Freehands["Username"], Freehands["Password"])
# client1.on_connect = on_connectToFreehands
# client1.on_message = on_message
# client1.on_publish = on_publish
# client1.on_disconnect = on_disconnect
# client1.broker = Freehands["Mqtt_ip"]
# client1.port = Freehands["Mqtt_port"]
# client1.topic = "#"
# client1.keepalive = 60
...
#     client.loop_start()
# except:
#     _LOGGER.error("CONNECTION ERROR TO BROKER GATEWAY")
...
#     client1.loop_start()
# except:
#     _LOGGER.error("CONNECTION ERROR TO FREEHANDS")
